...
<body data-bs-theme="<?php echo $siteTheme; ?>">
    ...
    <div class="container card card-body">
        ...
        <a href="https://discord.com/oauth2/authorize?client_id=<?php echo (int)$discord["clientid"]; ?>&response_type=code&redirect_uri=http%3A%2F%2F<?php echo $_SERVER["SERVER_NAME"]; ?>%2FApi%2FDiscordVerification.ashx&scope=identify">Click here to verify using your Discord account</a>
    </div>
