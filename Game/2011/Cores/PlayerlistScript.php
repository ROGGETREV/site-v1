...
addContextMenuButton("Send " .. friendWord .. " Request", 
	...
	--DoIt
	function(player) 
		game:httpGet("http://shitblx.cf/Api/Friendship.ashx?ID="..player.userId.."&type=add&authentication="..authentication.."&"..randint())
...
addContextMenuButton("Un" .. friendWordLowercase, 
	...
	--DoIt
	function(player) 
		game:httpGet("http://shitblx.cf/Api/Friendship.ashx?ID="..player.userId.."&type=remove&authentication="..authentication.."&"..randint())
